...
export const GUIA: GrupoDoGuia[] = [
  {
    ...
    cenarios: [
      ...
      },
      {
        ...
        preparo: 'Fernanda Alves ainda não assinou. Para ver a compra sem novo aceite, use Larissa Prado, que já assinou.',
        passos: [
          ...
          { perfil: L, texto: 'Entre como Fernanda. O termo aparece com "CONTRATANTE: Fernanda Alves, CPF …" mesclado no texto. Aceite.' },
