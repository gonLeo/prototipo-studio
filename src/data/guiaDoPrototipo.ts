...
export const PERSONAS = [
  ...
  { nome: 'Fernanda Alves', perfil: 'Aluna', estado: 'Bolsista cadastrada pela administração, ainda sem aceitar o termo.' },
  { nome: 'Juliana Rocha', perfil: 'Aluna', estado: 'Fez a aula experimental e tem uma compra que o gateway recusou.' },
    ...
    cenarios: [
      {
        ...
        resumo: 'A interessada compra o pacote, aceita o termo, preenche a anamnese e já agenda a primeira aula.',
        fluxo: '6.1 Matrícula pelo site',
        regras: ['RN-01', 'RN-19', 'RN-36'],
        requisitos: ['RF-ALU-04', 'RF-ALU-08', 'RF-AGD-10', 'RF-NOT-01'],
        passos: [
          { perfil: S, texto: 'Na tela de login, clique em "Abrir a matrícula pública".' },
          { perfil: S, texto: 'Preencha os dados, escolha um pacote e a forma de pagamento. O resumo mostra os créditos e a validade projetada.' },
          { perfil: S, texto: 'Aceite o termo, responda a anamnese e conclua. O pagamento é simulado e aprovado na hora.' },
          { perfil: S, texto: 'Ainda no fluxo, agende a primeira aula na grade que aparece.' },
          { perfil: A, texto: 'Em Alunas, abra a ficha da nova aluna.' },
        ],
        conferir: [
          'A ficha mostra a carteira ativa, a venda confirmada e o agendamento com o crédito reservado.',
          'No login, ela aparece sem o aviso "Aguardando aceite": o termo foi assinado dentro do próprio fluxo.',
        ],
      },
      {
        id: 'experimental',
      ...
      },
      {
        ...
        resumo: 'A aluna nasce aguardando aceite. Bolsista conclui só com o termo; as demais pagam no primeiro acesso.',
        fluxo: '6.3 Cadastro administrativo com bolsa',
        regras: ['RN-18', 'RN-19'],
        requisitos: ['RF-ALU-01', 'RF-ALU-02', 'RF-ALU-03', 'RF-ALU-08', 'RF-BOL-01', 'RF-BOL-02'],
        preparo: 'Fernanda Alves já está neste estado como bolsista. Para ver o caso com pagamento, cadastre uma aluna nova sem marcar bolsa.',
        passos: [
          { perfil: A, texto: 'Em Alunas, clique em "Nova aluna". Escolha o pacote e, se for o caso, marque "bolsista" — tudo na mesma tela.' },
          { perfil: L, texto: 'Entre como a aluna cadastrada. O menu tem só "Painel", e o painel pede o termo e a anamnese.' },
          { perfil: L, texto: 'Aceite e responda. Bolsista termina aqui, com os créditos liberados.' },
          { perfil: L, texto: 'Sem bolsa, aparece o passo de pagamento: confirme para liberar o acesso.' },
        ],
        conferir: [
          ...
          'Entre como Fernanda de novo: o menu completo apareceu.',
        ],
      },
      {
        id: 'termo-professora',
        titulo: 'Termo de aceite da professora',
        resumo: 'Professora nova também assina termo. O acesso fica bloqueado até o aceite.',
        regras: [],
        ...
        conferir: ['O menu completo aparece na hora, sem passo de pagamento.', 'Na aba "Professoras" do termo, o contador de aceites subiu.'],
      },
    ],
  },
  {
    ...
    cenarios: [
      {
        ...
        preparo: 'Larissa Prado tem pacote Flow válido até 08/11/2026.',
        passos: [
          { perfil: L, texto: 'Entre como Larissa e abra Meu pacote.' },
          { perfil: L, texto: 'Escolha o Starter (45 dias). A prévia mostra 13 créditos resultantes e avisa que a validade atual, mais longa, foi mantida.' },
          { perfil: L, texto: 'Pague.' },
        ],
        conferir: [
          'A carteira continua sendo uma só, agora com 13 disponíveis e a mesma validade.',
          'O histórico de compras registra a nova venda; em Notificações há a confirmação de compra.',
          'Regra adotada: a validade resultante é a mais distante entre a atual e a do pacote (ponto em aberto PA-10), não a do pacote novo.',
        ],
      },
      {
        id: 'nova-carteira',
      ...
      {
        id: 'ajuste-manual',
        titulo: 'Ajuste manual de créditos',
        resumo: 'Conceder, estornar ou prorrogar, sempre com motivo. Tudo fica no extrato e na auditoria.',
        regras: ['RN-37'],
        requisitos: ['RF-CRE-09', 'RF-PER-03', 'RF-PER-05'],
        passos: [
          { perfil: A, texto: 'Na ficha da Larissa, clique em "Ajustar créditos".' },
          { perfil: A, texto: 'Conceda 2 créditos com um motivo. Depois tente estornar mais créditos do que os utilizados.' },
          { perfil: A, texto: 'Prorrogue a validade em alguns dias.' },
        ],
        conferir: [
