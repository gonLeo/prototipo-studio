...
export const PERSONAS = [
  ...
  { nome: 'Renata Souza', perfil: 'Aluna', estado: 'Aluna de convênio Wellhub: reserva pelo aplicativo do parceiro, sem créditos no studio. Pode participar de workshop pagando à parte.' },
  { nome: 'Aline Martins', perfil: 'Aluna', estado: 'Pacote vencido com créditos sobrando. Sem pacote ativo.' },
  { nome: 'Mariana Teixeira', perfil: 'Aluna', estado: 'Aluna do TotalPass: a reserva dela foi registrada à mão, porque esse convênio opera em contingência na Fase 1.' },
];
...
export const SIMULACOES = [
  ...
  { o: 'Convênio', como: 'Não há API de parceiro. As mensagens que viriam do Wellhub — reserva, cancelamento, check-in — são disparadas pela administração em Convênios. O TotalPass não tem integração nesta fase: as reservas dele são registradas à mão, pela mesma tela (contingência, RF-CNV-14).' },
  { o: 'Anexos', como: 'Comprovante do fechamento de comissão e anexo da justificativa guardam só o nome do arquivo: não há upload no protótipo.' },
...
export const GUIA: GrupoDoGuia[] = [
    ...
    cenarios: [
      ...
      },
      {
        ...
        passos: [
          ...
          { perfil: A, texto: 'Na lista, busque pelo telefone dela: o mesmo campo aceita nome, CPF ou telefone (RF-ALU-10).' },
    ...
    cenarios: [
      {
        ...
        passos: [
          ...
          { perfil: A, texto: 'Tente alocar Aline Martins, que está sem pacote ativo.' },
        ...
        conferir: [
          ...
          'Aline é recusada por falta de pacote, com a saída sugerida na própria mensagem.',
      ...
      {
        id: 'sem-cadastro',
        titulo: 'Convidada sem cadastro no workshop',
        resumo: 'Quem não é aluna do studio entra com nome e telefone, sem pacote e sem consumo de créditos.',
        fluxo: '6.7 Criação de workshop ou aula particular',
        regras: [],
        requisitos: ['RF-AEX-06', 'RF-PRE-02'],
        preparo: 'Um workshop criado, com professora vinculada.',
        passos: [
          { perfil: A, texto: 'Em Aulas excepcionais, clique em "Alocar alunas" no workshop.' },
          { perfil: A, texto: 'Marque "Participante sem cadastro": a lista de alunas dá lugar a nome e telefone, e "sem consumo de créditos" fica marcado e travado.' },
          { perfil: A, texto: 'Informe o nome e o telefone, escolha o motivo e aloque.' },
          { perfil: P, texto: 'No dia, abra a chamada da aula excepcional.' },
          { perfil: P, texto: 'Marque a presença dela e finalize a chamada.' },
        ],
        conferir: [
          'Na lista de participantes ela aparece com o selo "Sem cadastro" e o telefone.',
          'Na chamada ela entra como qualquer participante, mas sem link de ficha: não há cadastro para abrir.',
          'A presença dela conta no número de presenças da comissão da professora, e nenhum crédito é movimentado.',
          'Ela não aparece em Alunas, nem na retenção: não é aluna do studio.',
        ],
      },
      {
        id: 'convenio-a-parte',
        titulo: 'Aluna de convênio paga à parte',
        resumo: 'O convênio cobre só a grade regular. Para o workshop, ela entra sem consumo, pagando por fora.',
        fluxo: '6.7 Criação de workshop ou aula particular',
        regras: [],
        requisitos: ['RF-AEX-11', 'RF-AEX-06'],
        preparo: 'Um workshop criado e Renata Souza, a aluna de convênio.',
        passos: [
          { perfil: A, texto: 'Em "Alocar alunas", escolha Renata: a opção dela diz "convênio, só com pagamento à parte".' },
          { perfil: A, texto: 'Tente alocar sem marcar nada: o aviso explica que o convênio não dá créditos no studio, e o botão fica bloqueado.' },
          { perfil: A, texto: 'Marque "Sem consumo de créditos", escolha o motivo "Pagamento avulso" e aloque.' },
          { perfil: P, texto: 'Na chamada da aula, ela aparece com "Convênio · participação paga à parte".' },
        ],
        conferir: [
          'Na v2.0 a alocação dela era recusada sempre; na v2.1 o que não existe é a participação pelo convênio, não a participação.',
          'Nenhum crédito é debitado, porque ela não tem carteira no studio.',
          'A aula excepcional continua fora do espelhamento dos convênios: o parceiro não vê o workshop.',
        ],
      },
      {
  ...
  },
  {
    ...
    cenarios: [
      ...
      },
      {
        ...
        requisitos: ['RF-REE-01', 'RF-REE-02', 'RF-REE-03', 'RF-REE-05', 'RF-REE-07', 'RF-REE-08', 'RF-REE-09', 'RF-REE-10', 'RF-NOT-12'],
        ...
        passos: [
          ...
          { perfil: A, texto: 'A prévia mostra a data da compra, os dias decorridos, o percentual consumido e o valor devolvido já descontando os créditos utilizados. Confirme.' },
          { perfil: A, texto: 'Tente reembolsar uma compra antiga (a Starter da Larissa, de mais de três meses atrás).' },
          { perfil: A, texto: 'Para ver a recusa por consumo: em Parâmetros, aumente o "Prazo de arrependimento" para 60 dias e tente reembolsar a compra da Patrícia, que já usou 75% dos créditos.' },
        ...
        conferir: [
          ...
          'A compra antiga é recusada pelo prazo; com o prazo ampliado, a da Patrícia é recusada pelo percentual. As duas recusas indicam o reembolso por motivo legal como saída (RF-REE-07).',
  ...
  },
  {
    ...
    cenarios: [
      ...
      {
        id: 'totalpass-contingencia',
        titulo: 'TotalPass em contingência manual',
        resumo: 'Na Fase 1 só o Wellhub é integrado. O TotalPass é registrado à mão, pela mesma tela.',
        regras: [],
        requisitos: ['RF-CNV-14', 'RF-CNV-13', 'EV-21'],
        preparo: 'Mariana Teixeira já está cadastrada como aluna do TotalPass, com a reserva registrada em contingência.',
        passos: [
          { perfil: A, texto: 'Em Convênios → Credenciais, compare os dois: o Wellhub tem credencial e "Sincronizar grade"; o TotalPass, não.' },
          { perfil: A, texto: 'Tente cadastrar uma credencial do TotalPass: a recusa explica que a integração automática é da Fase 2 (EV-21).' },
          { perfil: A, texto: 'Na aba Reservas, use "Registrar reserva manual" para incluir Mariana em outra aula.' },
          { perfil: A, texto: 'Veja o relatório de convênios: as duas operadoras aparecem, com as reservas de cada uma.' },
        ],
        conferir: [
          'A reserva manual ocupa vaga e aparece na chamada igual à que viria pela integração — o que muda é quem a registrou.',
          'O selo do TotalPass diz "Contingência", e o texto explica que a integração está prevista para a Fase 2.',
          'A grade espelhada continua sendo só a do Wellhub.',
        ],
      },
      {
    ...
    cenarios: [
      ...
      },
      {
        ...
        passos: [
          ...
          { perfil: A, texto: '"Fechar período" — a confirmação avisa se ainda há chamadas pendentes.' },
          { perfil: A, texto: 'Em "Registrar pagamento", informe o nome do arquivo do comprovante — ou deixe em branco: o anexo é opcional (RF-COM-09).' },
        ],
        conferir: [
          'O fechamento aparece como "Pago" para a administração e para a professora.',
          'A linha do fechamento diz "comprovante: <arquivo>" ou "sem comprovante anexado" — nunca deixa a dúvida no ar.',
