...
const CHAVES_ESTRANGEIRAS: Record<string, Record<string, string>> = {
  ...
  aulasExcepcionais: { categoriaAulaId: 'categoriasAula', espacoId: 'espacos', autorId: 'usuarios' },
  professorasDaAula: { aulaExcepcionalId: 'aulasExcepcionais', professoraId: 'professoras' },
  alocacoes: { aulaExcepcionalId: 'aulasExcepcionais', alunaId: 'alunas', autorId: 'usuarios' },
  ...
  chamadas: {
    ocorrenciaSessaoId: 'ocorrenciasSessao',
