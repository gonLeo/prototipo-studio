...
3. `PROGRESSO_ATUALIZACAO.md` — etapas da migração já entregues, o que cada uma implementou e como testar. É o arquivo de progresso corrente.
...
Desenvolvimento em etapas, **uma etapa por ciclo**. Nunca avance para a próxima etapa do `PLANO_ATUALIZACAO_ESCOPO.md` sem eu confirmar explicitamente que validei a anterior. Ao terminar uma etapa:
